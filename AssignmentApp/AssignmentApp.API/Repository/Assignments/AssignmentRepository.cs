...
public class AssignmentRepository : IAssignmentRepository
{
    ...
    public async Task<Data.Entities.StudentAssignment> SubmitAssignment(int AssignmentId, int studentId, IFormFileCollection? files)
    {
        ...
        foreach (var item in files)
        {
            var file = new Data.Entities.File()
            {
                ...
                Path = "/UploadFiles/" + Path.GetFileName(item.FileName.Trim()),
